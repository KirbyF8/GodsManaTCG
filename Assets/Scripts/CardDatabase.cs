...
public class CardDatabase : MonoBehaviour
{
   public static List<Card> cardList = new List<Card>();
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(18, "Último esfuerzo Nº", 0, 0, 0, 0, "Destruye un elegido Nº después destruye un elegido del rival, después de activar el efecto no puedes invocar elegidos que no sean Nº ", "Mágica", "", 0));
        cardList.Add(new Card(19, "Retirada Nº", 0, 0, 0, 0, "Devuelve al Deck cualquier número de Nº, roba una carta por cada una", "Mágica", "", 0));
        cardList.Add(new Card(20, "Regrso Nº", 0, 0, 0, 0, "Cuando una elegida Nº es destruida, envia al deck 1 elegida Nº", "Trampa", "", 0));
        cardList.Add(new Card(21, "Plan de contención Nº", 0, 0, 0, 0, "Cuando una elegida Nº es destruida, envia al deck del cementerio 1 elegida Nº", "Trampa", "", 0));
        ...
        cardList.Add(new Card(41, "Reglas antiguas", 0, 0, 0, 0, "Elimina todos los manas de los dioses", "Mágica", "", 0));
        cardList.Add(new Card(42, "Último recurso", 0, 0, 0, 0, "Si tu vida es 1, obten 20 de mana", "Mágica", "", 0));
        cardList.Add(new Card(43, "Vuelta a lo básico", 0, 0, 0, 0, "Transforma todo el mana de los dioses a mana", "Mágica", "", 0));
        cardList.Add(new Card(44, "Último esfuerzo", 0, 0, 0, 0, "Cuando un elegido vaya a ser destruido mantenlo a 1 de vida", "Trampa", ""   , 0));
        cardList.Add(new Card(45, "Castigo divino", 0, 0, 0, 0, "Destruye todos los monstruos en el campo", "Mágica", "", 0));
        ...
        cardList.Add(new Card(53, "Plan Bolt", 0, 0, 0, 0, "Si tienes 1 Bolt en el campo, 1 en el cementerio y 1 en la mano puedes invocar a K.R.I.S", "Mágica", "", 0));
        cardList.Add(new Card(54, "Eureka!", 0, 0, 0, 0, "Puedes equipar hasta 6 elegidos Bolt con nombres diferentes a K.R.I.S, este gana 1 de defensa y 2 de vida por cada uno", "Mágica", "", 0));
        ...
        cardList.Add(new Card(61, "Pistola Bleck", 0, 0, 0, 0, "Cuando el elegido que la lleve equipada ataque inflige 1 de daño a tu oponente", "Equipo", "", 0));
        ...
        cardList.Add(new Card(63, "EléctroBola", 0, 0, 0, 0, "Solo puede ser equipada en elegidos bolt, duplica el ataque de estos cuando atacan a un elegido que no sea de Miknit", "Equipo", "", 0));
        // Revolución Steampunk 2 (Mecánica Fantástica y Artefactos Extaordianrios)
        ...
        cardList.Add(new Card(71, "Ruby VIII", 5, 2, 2, 5, "Cuando es invocada roba una carta mágica a eleccion", "Miknit", "", 0));
        ...
        // Fichas
        cardList.Add(new Card(0, "Soldado de arena", 0, 0, 4, 1, "No puede ser destruido en batalla si Nº11 esta en el campo", "N", "", 0));
