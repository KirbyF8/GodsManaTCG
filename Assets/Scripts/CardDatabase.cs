...
public class CardDatabase : MonoBehaviour
{
   public static List<Card> cardList = new List<Card>();
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(16, "Nº2", 11, 11, 10, 9, "  <sprite name=AlSerInvocado> de forma especial busca una carta trampa Nº y añadela a <sprite name=Mano>, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº2", "Chronos", "Exploradora", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }, new int[2] {1,11}, null, new string[2] {"Nº", "Nº2"}, new string[2] {"Trampa", ""})); // TODO efecto 1
        
        cardList.Add(new Card(17, "Nº1", 12, 12, 12, 12, "  <sprite name=AlSerInvocado> de forma especial gasta todo tu mana y transformalo en mana de chronos, esta carta no puede ser seleccionada por efectos, al final de cada ronda recupera todo su HP", "Chronos", "Guerrera", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnEndTurn }, new int[2] {8,6}, new int[2] {99,1}, new string[2] {"", "Nº1"}, null, new string[2] {"Chronos", ""}, null, new int[2] {0,4}, null, null, new int[2] {0,99}));

        cardList.Add(new Card(18, "Último esfuerzo Nº", 2, 0, 0, 0, "Destruye un elegido Nº después destruye un elegido del rival, después de activar el efecto no puedes invocar elegidos que no sean Nº ", "Chronos", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }, new int[2] {2,2}, null, new string[2] {"Nº", ""}, new string[2] {"Elegido", "Elegido"}, null, null, new int[2] {4,4} ));

        cardList.Add(new Card(19, "Retirada Nº",2, 0, 0, 0, "Devuelve al  <sprite name=Deck>  una carta Nº en tu cementerio, roba una carta", "Chronos", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }, new int[2] {13,1}, null, new string[2] {"Nº", ""}));
