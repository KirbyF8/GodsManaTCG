...
public class CardDatabase : MonoBehaviour
{
   public static List<Card> cardList = new List<Card>();
    ...
    private void Awake()
    {
        ...
        // Mundo Antiguo 2 (Nº)
        cardList.Add(new Card(6, "Nº12 ", 1, 3, 0, 3, "  <sprite name=AlSerDestruido> invoca de forma especial desde tu mano o  <sprite name=Deck> a Nº11", "Chronos", "Guerrera", 0, new List<ActivationType> { ActivationType.OnLeaveField }));
        ...
        cardList.Add(new Card(8, "Nº10", 3, 4, 1, 3, "  <sprite name=AlSerInvocado> de forma especial roba 1 carta, <sprite name=AlSerDestruido> invoca de forma especial desde de tu <sprite name=Mano> o  <sprite name=Deck>  a Nº9 ", "Chronos", "Hechicera", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(9, "Nº9", 4, 8, 0, 1, "  <sprite name=AlSerInvocado> de forma especial destruye 1 elegido del rival que este en posición de ataque, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº8", "Chronos", "Pícara", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(10, "Nº8", 5, 6, 2, 4, "  <sprite name=AlSerInvocado> de forma especial inflije 1 de daño a todos los elegidos enemigos, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº7", "Chronos", "Mercenaria", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(11, "Nº7", 6, 9, 1, 6, "  <sprite name=AlSerInvocado> de forma especial destruye todos los elegidos heridos, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº6", "Chronos", "Mercenaria", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(12, "Nº6", 7, 10, 1, 4, "  <sprite name=AlSerInvocado> de forma especial inflije 5 de daño a un elegido o a tu rival, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº5", "Chronos", "Exploradora", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(13, "Nº5", 8, 7, 5, 5, "  <sprite name=AlSerInvocado> de forma especial reduce a 0 la defensa de todos los elegidos rivales, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº4", "Chronos", "Guerrera", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(14, "Nº4", 9, 5, 10, 10, "  <sprite name=AlSerInvocado> de forma especial coloca a todos los elegidos en posición de defensa, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº3", "Chronos", "Curandera", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(15, "Nº3", 10, 12, 6, 9, "  <sprite name=AlSerInvocado> de forma especial destruye tantos elegidos hasta que quede uno en cada campo, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº2", "Chronos", "Bárbara", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(16, "Nº2", 11, 11, 10, 9, "  <sprite name=AlSerInvocado> de forma especial busca una carta mágica o trampa Nº y añadela a <sprite name=Mano>, <sprite name=AlSerDestruido> invoca de forma especial <sprite name=Mano> o  <sprite name=Deck>  a Nº2", "Chronos", "Exploradora", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnLeaveField }));
        cardList.Add(new Card(17, "Nº1", 12, 12, 12, 12, "  <sprite name=AlSerInvocado> de forma especial gasta todo tu mana, esta carta no puede ser seleccionada por efectos, al final de cada ronda recupera todo su HP", "Chronos", "Guerrera", 0, new List<ActivationType> { ActivationType.OnEnterField, ActivationType.OnEndTurn }));

        cardList.Add(new Card(18, "Último esfuerzo Nº", 2, 0, 0, 0, "Destruye un elegido Nº después destruye un elegido del rival, después de activar el efecto no puedes invocar elegidos que no sean Nº ", "Chronos", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(19, "Retirada Nº",5, 0, 0, 0, "Devuelve al  <sprite name=Deck>  cualquier número de Nº en tu cementerio, roba una carta por cada una", "Chronos", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(24, "Zolbo", 2, 1, 1, 4, "  <sprite name=AlSerInvocado> restaura el HP al completo de cualquier elegido", "Chronos", "Curandero", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(35, "Amaro", 1, 5, 1, 1, "<sprite name=AlSerInvocado> destruye un elegido con 0 de defensa, si no puede esta carta es destruida", "Chronos", "", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(103, "Leynla Dragón", 6, 6, 8, 12, "No puede ser invocada de forma normal, cuando acabe la fase de combate vuelve a la mano e Invoca a Leynla", "Miknit", "Barbara", 0, new List<ActivationType> { ActivationType.OnEndBattle }));
        ...
        cardList.Add(new Card(142, "Misil Mágico", 1, 0, 0, 0, "Inflije 1 de HP a un elegido", "Miknit", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(143, "Escarchar", 1, 0, 0, 0, "Reduce en 1 la DF de un elegido", "Miknit", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(144, "Refuerzos", 2, 0, 0, 0, "Roba un mercenario  <sprite name=Deck>, si su coste es 1 invocalo de forma especial", "Murgu", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(145, "Portal", 10, 0, 0, 0, "Invoca 3 Hechiceros  <sprite name=Deck>,mano o zona de destierros", "Miknit", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(147, "Fireball", 8, 0, 0, 0, "Destruye todos los monstruos en el campo", "Miknit", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(148, "Resucitar", 2, 0, 0, 0, "Devuelve un elegido del cementerio al  <sprite name=Deck>", "Dana", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(149, "Perdición", 7, 0, 0, 0, "Envia a la zona de destierros un elegido en el campo", "Yrys", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(151, "Jarron Avaricioso", 2, 0, 0, 0, "Roba dos cartas", "N", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(152, "Jarron Generoso", 2, 0, 0, 0, "Descarta dos cartas", "N", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(153, "Agujero de Gusano", 10, 0, 0, 0, "Destierra todos los monstruos en el campo, después ambos jugadores invocan tantos monstruos del cementerio como puedan", "Yrys", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField })); //TODO
        cardList.Add(new Card(154, "Lluvia de meteroros", 9, 0, 0, 0, "Destruye todos los monstruos de tu oponente", "Yrys", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        cardList.Add(new Card(155, "Curar heridas", 1, 0, 0, 0, "Recupera 5LP", "Dana", "Mágica", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(1001, "Nº0", 1, 1, 1, 1, "<sprite name=AlSerInvocado> destierra todas las cartas Nº en el cementerio aumenta en 1 su vida por cada una", "Chronos", "Invocadora", 0, new List<ActivationType> { ActivationType.OnEnterField }));
        ...
        cardList.Add(new Card(0, "Chakal", 0, 5, 1, 2, "<sprite name=AlAtacar> cambia a posicion de defensa", "N", "Invocación", 0, new List<ActivationType> { ActivationType.OnAttack }));
        cardList.Add(new Card(0, "Lia", 0, 9, 0, 1, "<sprite name=AlSerDestruido> en batalla envia del cementerio al  <sprite name=Deck>  la carta de equipo Lia", "none", "Invocación", 0, new List<ActivationType> { ActivationType.OnLeaveField }));
        cardList.Add(new Card(0, "Enredaderas", 0, 0, 5, 5, "Al final del turno crea una copia de si misma, si no puede inflije 1LP al jugador que posea esta carta", "N", "Invocación", 0, new List<ActivationType> { ActivationType.OnEndTurn }));
        cardList.Add(new Card(0, "Yu", 0, 0, 0, 2, "<sprite name=AlSerDestruido> omites tu proximo robo", "N", "Invocación", 0, new List<ActivationType> { ActivationType.OnLeaveField }));
        cardList.Add(new Card(0, "Oveja", 0, 1, 1, 2, "<sprite name=AlSerDestruido> omites tu proximo robo", "N", "Invocación", 0, new List<ActivationType> { ActivationType.OnLeaveField }));
        cardList.Add(new Card(0, "Zorro", 0, 3, 1, 2, "<sprite name=AlSerDestruido> omites tu proximo robo", "N", "Invocación", 0, new List<ActivationType> { ActivationType.OnLeaveField }));
