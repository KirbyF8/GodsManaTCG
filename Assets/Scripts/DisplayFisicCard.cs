...
public class DisplayFisicCard : MonoBehaviour
{
    ...
    public SpriteRenderer fondoCarta;
    public SpriteRenderer fondoMana;
    public SpriteRenderer fondoName;
    public SpriteRenderer fondoTxt;
